...
UPDATE kopas SET qnt_copas=0 WHERE selecao='Japão';

ALTER TABLE kopas ADD column pts INTEGER AFTER qnt_copas


CREATE TABLE IF NOT EXISTS estadios( id BIGSERIAL CONSTRAINT pk_estadios PRIMARY KEY,
edicao VARCHAR NOT NULL,
ano VARCHAR(4) NOT NULL,
estadio VARCHAR NOT NULL,
LOCAL VARCHAR(128) NOT NULL,
publico_pagante integer NOT NULL);
